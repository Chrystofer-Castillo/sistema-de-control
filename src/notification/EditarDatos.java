...
public class EditarDatos extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PNFcombo = new javax.swing.JComboBox<>();
        ...
        panelRound1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 80, 100, 30));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Trayecto:");
        jLabel8.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        panelRound1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 120, 120, 30));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel9.setText("Sección:");
        jLabel9.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        panelRound1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 160, 120, 30));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("PNF:");
        jLabel3.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        panelRound1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 40, 120, 30));
        ...
        panelRound1.add(textFieldSeccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 160, 210, 30));
        panelRound1.add(textFieldTrayecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 120, 210, 30));
        ...
        SedeCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-" }));
        SedeCombo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SedeComboActionPerformed(evt);
            }
        });
        panelRound1.add(SedeCombo, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 80, 210, -1));

        PNFcombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "Contaduría Pública", "Informática", "Educación Especial", "Agroalimentación", "Historia" }));
        PNFcombo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PNFcomboActionPerformed(evt);
            }
        });
        panelRound1.add(PNFcombo, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 40, 210, -1));
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            ...
            d.setTproyecto(textFieldTitulo.getText());
            d.setTxtnom(textFieldIntegrantes.getText());
    ...
    private void PNFcomboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PNFcomboActionPerformed
        String seleccion = (String) PNFcombo.getSelectedItem();
        SedeCombo.removeAllItems();

        if (seleccion.equals("-")) {
            SedeCombo.addItem("-");
        } else if (seleccion.equals("Informática")) {
            SedeCombo.addItem("Cabimas");
            SedeCombo.addItem("Ciudad Ojeda");
            SedeCombo.addItem("Los Puertos de Altagracia");
            SedeCombo.addItem("San Francisco");
            SedeCombo.addItem("San Pedro");
        } else if (seleccion.equals("Contaduría Pública")) {
            SedeCombo.addItem("Cabimas");
            SedeCombo.addItem("Mene Grande");
            SedeCombo.addItem("Ciudad Ojeda");
            SedeCombo.addItem("Los Puertos de Altagracia");
            SedeCombo.addItem("San Francisco");
            SedeCombo.addItem("San Pedro");
            ...
            SedeCombo.addItem("Cabimas");
            SedeCombo.addItem("Trujillo");
        } else if (seleccion.equals("Agroalimentación")) {
            SedeCombo.addItem("Cabimas");
            SedeCombo.addItem("San Francisco");
            SedeCombo.addItem("Bobures");
            SedeCombo.addItem("Trujillo");
            SedeCombo.addItem("San Pedro");
            SedeCombo.addItem("Bachaquero");
            SedeCombo.addItem("Ciudad Ojeda");
        } else if (seleccion.equals("Historia")) {
            SedeCombo.addItem("Trujillo");
        }
    }//GEN-LAST:event_PNFcomboActionPerformed
    ...
    private void cargarDatos(Datos d) {
        ...
        SedeCombo.setSelectedItem(d.getSede());
    ...
    public javax.swing.JComboBox<String> PNFcombo;
